# Validação transversal da v0.1 — relatório de testes

Data: 13/09/2026. Este documento registra o que foi verificado automaticamente e o que
...
4. Formatos reais de resposta do MCP para capacidade, folgas de equipe e iterações: a
   normalização é defensiva, mas só a conexão real confirma os campos.
