...
|---|---|---|---|---|---|---|---|---|---|
| **Claude Code** | macOS / Linux / Windows | A definir | `0.2.0` | Pendente | Pendente | `Planejado` | Nenhuma | Pendente | Pendente |
| **Google Antigravity** | macOS / Linux / Windows | A definir | `0.2.0` | Pendente | Pendente | `Planejado` | Nenhuma | Pendente | Pendente |
| **Codex** | macOS / Linux / Windows | A definir | `0.2.0` | Pendente | Pendente | `Planejado` | Nenhuma | Pendente | Pendente |
| **Cursor** | macOS / Linux / Windows | A definir | `0.2.0` | Pendente | Pendente | `Planejado` | Nenhuma | Pendente | Pendente |
