...
2. Configure o servidor MCP oficial do Azure DevOps na configuração de MCP do Codex, apontando para o servidor remoto oficial da organização.
3. Instale este bundle conforme o procedimento do Codex.
